...
var MonthView = function (_React$Component) {
    ...
    function MonthView() {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = MonthView.__proto__ || Object.getPrototypeOf(MonthView)).call.apply(_ref, [this].concat(args)));
    ...
    _createClass(MonthView, [{
        ...
        value: function render() {
            ...
            var month = _dates2.default.visibleDays(date, culture);
            ...
            return _react2.default.createElement(
                "div",
                { className: (0, _classnames2.default)(_calendar2.default.rbcMonthView, className) },
                _react2.default.createElement(
                    "div",
                    { className: (0, _classnames2.default)(_calendar2.default.rbcRow, _calendar2.default.rbcMonthHeader) },
        ...
        value: function renderHeaders(row, format, culture) {
            ...
            return _dates2.default.range(first, last, "day").map(function (day, idx) {
                return _react2.default.createElement(
                    "div",
                    { key: "header_" + idx, className: _calendar2.default.rbcHeader, style: (0, _eventLevels.segStyle)(1, 7) },
        ...
        value: function getDerivedStateFromProps(nextProps) {
            return { needLimitMeasure: !_dates2.default.eq(nextProps.date, this.props.date) };
        }
    }]);
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.renderWeek = function (week, weekIdx) {
        ...
        return _react2.default.createElement(_DateContentRow2.default, {
            ...
            className: _calendar2.default.rbcMonthRow,
            getNow: getNow,
            date: date,
            range: week,
            events: events,
    ...
    this.readerDateHeading = function (_ref3) {
        ...
        return _react2.default.createElement(
            "div",
            _extends({}, props, {
                className: (0, _classnames2.default)(className, isOffRange && _calendar2.default.rbcOffRange, isCurrent && _calendar2.default.rbcCurrent)
            }),
