    ...
    _createClass(TimeGrid, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    "div",
                    { ref: "content", className: _calendar2.default.rbcTimeContent },
                    ...
                    eventsRendered,
                    React.createElement("div", { ref: "timeIndicator", className: _calendar2.default.rbcCurrentTimeIndicator })
                )
            );
        }
    }, {
        ...
        value: function renderHeader(range, events, width, resources) {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement("div", { className: (0, _classnames2.default)(_calendar2.default.rbcLabel, _calendar2.default.rbcHeaderGutter), style: { width: width } }),
                ...
                React.createElement(
                    ...
                    React.createElement(_DateContentRow2.default, {
                        getNow: getNow,
                        minRows: 2,
                        range: range,
                        rtl: this.props.rtl,
        ...
        value: function renderHeaderCells(range) {
            ...
            return range.map(function (date, i) {
                ...
                return React.createElement(
                    ...
                    drilldownView ? React.createElement(
                        "a",
                        {
                            href: "#",
