...
var Agenda = function (_React$Component) {
    ...
    function Agenda() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Agenda.__proto__ || Object.getPrototypeOf(Agenda)).call.apply(_ref, [this].concat(args))), _this), _this.renderDay = function (day, events, dayKey) {
            ...
            return events.map(function (event, idx) {
                var _ref2 = eventPropGetter ? eventPropGetter(event, (0, _accessors.accessor)(event, startAccessor), (0, _accessors.accessor)(event, endAccessor), (0, _selection.isSelected)(event, selected)) : {},
                ...
                var first = idx === 0 ? _react2.default.createElement(
                    "td",
                    { rowSpan: events.length, className: _calendar2.default.rbcAgendaDateCell },
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "td",
                        { className: _calendar2.default.rbcAgendaTimeCell },
                        _this.timeRangeLabel(day, event)
                    ),
                    _react2.default.createElement(
                        "td",
                        { className: _calendar2.default.rbcAgendaEventCell },
            ...
            var label = (0, _messages2.default)(messages).allDay;
            ...
            if (_dates2.default.gt(day, start, "day")) {
                labelClass = _calendar2.default.rbcContinuesPrior;
            }

            return _react2.default.createElement(
                "span",
                { className: (0, _classnames2.default)(labelClass, _dates2.default.lt(day, end, "day") ? _calendar2.default.rbcContinuesAfter : "") },
            ...
            if (isOverflowing) {
                _class2.default.addClass(header, _calendar2.default.rbcHeaderOverflowing);
                header.style.marginRight = (0, _scrollbarSize2.default)() + "px";
            } else {
                _class2.default.removeClass(header, _calendar2.default.rbcHeaderOverflowing);
            }
    ...
    _createClass(Agenda, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: _calendar2.default.rbcAgendaView },
                _react2.default.createElement(
                    "table",
                    { ref: "header" },
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "th",
                                { className: _calendar2.default.rbcHeader, ref: "dateCol" },
                                messages.date
                            ),
                            _react2.default.createElement(
                                "th",
                                { className: _calendar2.default.rbcHeader, ref: "timeCol" },
                                messages.time
                            ),
                            _react2.default.createElement(
                                "th",
                ...
                _react2.default.createElement(
                    "div",
                    { className: _calendar2.default.rbcAgendaContent, ref: "content" },
                    _react2.default.createElement(
                        "table",
                        null,
                        _react2.default.createElement(
...
Agenda.title = function (start, _ref5) {
    var _ref5$length = _ref5.length,
        length = _ref5$length === undefined ? length = Agenda.defaultProps.length : _ref5$length,
