    ...
    var DragAndDropCalendar = function (_React$Component) {
        ...
        _createClass(DragAndDropCalendar, [{
            ...
            value: function render() {
                ...
                props.className = (0, _classnames2.default)(props.className, _calendar2.default.rbcAddonsDnd, this.state.isDragging && _calendar2.default.rbcAddonsDndIsDragging);
