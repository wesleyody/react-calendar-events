...
var DraggableBackgroundWrapper = function (_React$Component) {
    ...
    function DraggableBackgroundWrapper() {
        ...
        return _possibleConstructorReturn(this, (DraggableBackgroundWrapper.__proto__ || Object.getPrototypeOf(DraggableBackgroundWrapper)).apply(this, arguments));
    }

    _createClass(DraggableBackgroundWrapper, [{
        key: "render",
        value: function render() {
            ...
            if (isOver) {
                resultingChildren = _react2.default.cloneElement(children, {
                    className: (0, _classnames2.default)(children.props.className, _calendar2.default.rbcAddonsDndOver)
                });
            }
