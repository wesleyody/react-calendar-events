...
var DateContentRow = function (_React$Component) {
    ...
    function DateContentRow() {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = DateContentRow.__proto__ || Object.getPrototypeOf(DateContentRow)).call.apply(_ref, [this].concat(args)));
        ...
        _this.handleShowMore = function (slot) {
            ...
            var row = (0, _querySelectorAll2.default)((0, _reactDom.findDOMNode)(_this), _calendar2.default.rbcRowBg)[0];
        ...
        _this.renderHeadingCell = function (date, index) {
            ...
            return renderHeader({
                ...
                className: (0, _classnames2.default)(_calendar2.default.rbcDateCell, _dates2.default.eq(date, getNow(), "day") && _calendar2.default.rbcNow)
            });
        };
        ...
        _this.renderDummy = function () {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: _calendar2.default.rbcRowContent },
                    renderHeader && _react2.default.createElement(
                        "div",
                        { className: _calendar2.default.rbcRow, ref: _this.createHeadingRef },
                        range.map(_this.renderHeadingCell)
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: _calendar2.default.rbcRow, ref: _this.createEventRef },
                        _react2.default.createElement(
                            "div",
                            { className: _calendar2.default.rbcRowSegment, style: (0, _eventLevels2.segStyle)(1, range.length) },
                            _react2.default.createElement(
                                "div",
                                { className: _calendar2.default.rbcEvent },
                                _react2.default.createElement(
                                    "div",
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    renderHeader && _react2.default.createElement(
                        "div",
                        { className: _calendar2.default.rbcRow, ref: this.createHeadingRef },
