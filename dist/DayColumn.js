        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: (0, _classnames2.default)(_calendar2.default.rbcEventsContainer, { rtl: this.props.rtl }) },
                    this.renderEvents()
                ),
                selecting && _react2.default.createElement(
                    "div",
                    { className: _calendar2.default.rbcSlotSelection, style: slotStyle },
                    _react2.default.createElement(
                        "span",
                        null,
...
var _initialiseProps = function _initialiseProps() {
    ...
    this._selectable = function () {
        ...
        var maybeSelect = function maybeSelect(box) {
            ...
            if (onSelecting) {
                if (_dates2.default.eq(current.startDate, start, "minutes") && _dates2.default.eq(current.endDate, end, "minutes") || !onSelecting({ start: start, end: end })) {
                    return;
                }
            }
        ...
        var selectorClicksHandler = function selectorClicksHandler(box, actionType) {
            if (!(0, _Selection.isEvent)((0, _reactDom.findDOMNode)(_this2), box)) {
                _this2._selectSlot(_extends({}, selectionState(box), { action: actionType }));
            }
