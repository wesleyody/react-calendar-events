...
function _format ( localizer, formatter, adapter, value, format, culture ) {
    const result = typeof format === "function" ?
        format( adapter, value, culture, localizer ) :
        formatter.call( localizer, adapter, value, format, culture );
